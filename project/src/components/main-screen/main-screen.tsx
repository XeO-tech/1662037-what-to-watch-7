...
export default function MainScreen(): JSX.Element {
  ...
  if (
    isPromoMovieDataFetchError ||
    isMoviesDataFetchError ||
    !promoMovieData ||
    !moviesData
  ) {
  ...
  const onMyListButtonClick = () => {
    postToFavorites({
      id: String(promoMovieData.id),
      status: getMovieFavoritesStatusForUrl(isPromoFavorite),
    })
      .unwrap()
          ...
          <div className='film-card__info'>
            <div className='film-card__poster'>
              ...
              >
                <img
                  src={promoMovieData.backgroundImage}
                  alt={`${promoMovieData.name} poster`}
                  width={218}
                  height={327}
                />
              </Link>
            ...
            <div className='film-card__desc'>
              ...
              <p className='film-card__meta'>
                ...
                <span className='film-card__year'>
                  {promoMovieData.released}
                </span>
              </p>
              <div className='film-card__buttons'>
                <Link
                  to={AppRoute.PLAYER.replace(/:id/, String(promoMovieData.id))}
